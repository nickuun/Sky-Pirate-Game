...
@export var angular_drag: float = 2.15
@export var max_angular_speed: float = 2.2
@export var yaw_stabilize_damp: float = 17.0
@export var max_yaw_angular_speed: float = 1.35
@export var idle_yaw_kill_damp: float = 0.8
...
@export var roll_hold_torque: float = 44.0
@export var roll_stabilize_torque: float = 56.0
@export var max_roll_tilt_degrees: float = 2.8
...
@export var roll_limit_softness_degrees: float = 1.8
@export var roll_velocity_damp: float = 0.42
@export var min_roll_return_torque: float = 6.5
@export var max_roll_correction_torque: float = 4200.0
@export var upright_recovery_torque: float = 520.0
@export var max_roll_angular_speed: float = 0.58
